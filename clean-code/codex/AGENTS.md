...
This file defines mandatory working rules for Codex in this repository. Follow these instructions before making any code, test, refactor, review, or documentation change.
